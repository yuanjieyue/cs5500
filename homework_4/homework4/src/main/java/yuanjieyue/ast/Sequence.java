...
public class Sequence implements Statement {
	...
	public boolean equals(Object o) {
		...
		if (!getStatement1().equals(sequence.getStatement1())) {
			return false;
		}
		return getStatement2().equals(sequence.getStatement2());
	}

	@Override
	public int hashCode() {
		int result = getStatement1().hashCode();
		result = 31 * result + getStatement2().hashCode();
		return result;
	}
